      ...
      <div className={styles.content}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            ...
            fascinent, comme l'intelligence artificielle, la gestion de la data
            et l'automatisation. Pour moi, ces technologies ne sont pas
            ...
            antérieure en tant que développeur m’a permis d’acquérir une vision
            technique approfondie, enrichissant ma perspective stratégique en
            tant que Product Owner. Ce mélange unique de compétences techniques
            et de vision stratégique me permet de concevoir des solutions
            robustes et adaptées aux besoins des utilisateurs.
            <br />
            Ce que j'apprécie tout autant, c’est la gestion humaine des équipes.
            Je prends à cœur de progresser avec les personnes avec lesquelles je
            travaille, de les accompagner et de les inspirer pour relever
            ensembles des défis. <br />
